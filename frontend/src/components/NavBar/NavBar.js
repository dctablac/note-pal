...
export default function NavBar(props) {
    ...
    return (
        <nav id="nav-bar" className={props.isNightMode ? 'night-mode' : ''}>
            ...
            <div className="night-mode-switch-container" onClick={makeNightMode}>
                ...
                {/* <label htmlFor="night-mode-switch" id={isNightMode ? "night-mode-switch-label-active" : "night-mode-switch-label"} >
